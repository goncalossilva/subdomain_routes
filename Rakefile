...
begin
  ...
  Jeweler::Tasks.new do |gem|
    gem.name = "goncalossilva-subdomain_routes"
    ...
    gem.homepage = "http://github.com/goncalossilva/subdomain_routes"
    gem.authors = ["Matthew Hollingworth", "Akihiro Matsumura", "Goncalo Silva"]
